...
exports.RequireAdmin = exports.RequireStaff = exports.VerifyLogin = exports.CreateToken = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                token = jsonwebtoken_1.default.sign(req.body, Default_1.default.privateKey);
...
var VerifyLogin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        token = authenticationHeader === null || authenticationHeader === void 0 ? void 0 : authenticationHeader.split(" ")[1];
        if (!token) {
            return [2 /*return*/, res.sendStatus(401)];
        }
        //@ts-ignore
        req.user = jsonwebtoken_1.default.verify(token, Default_1.default.privateKey, function (error, decoded) {
            if (error) {
                return null;
            }
            return decoded;
...
var RequireStaff = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, User_Service_1.GetRoleUserLogined)(req)];
            case 1:
                role = _a.sent();
                if (role === Common_1.default.role.GUEST) {
                    return [2 /*return*/, res.status(403).json({ message: "NOT PERMISSION" })];
                }
                next();
                return [2 /*return*/];
        }
...
var RequireAdmin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                role = _a.sent();
                if (role !== Common_1.default.role.ADMIN) {
                    return [2 /*return*/, res.status(403).json({ message: "NOT PERMISSION" })];
                }
                next();
                return [2 /*return*/];
