...
export const GetListProductSortedByNameAndPriceSchema = object({
  body: object({
    typeName: string().required("Type name is required"),
    typePrice: string().required("Type price is required"),
  })
})

export const GetListProductByCategorySortedByNameAndPriceSchema = object({
  body: object({
    typeName: string().required("Type name is required"),
    typePrice: string().required("Type price is required"),
  }),
