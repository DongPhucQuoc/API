...
export const CreatePaypalHandler = async (req: Request, res: Response) => {
  ...
  const infoGuest = req.body.infoGuest;
...
const BodyGetListOrderByListPaypal = async (
  res: Response,
  paypals: PaypalDocument[]
) => {
  let result: any = [];
...
const BodyGetListProductByOrderDetails = async (
  res: Response,
  orderID: string
) => {
...
export const DeleteAllPaypalHandler = async (req: Request, res: Response) => {
  await DeleteAllPaypal({});
